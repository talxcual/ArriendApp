        ...
        Column(
            ...
            Card(
                ...
                Column(modifier = Modifier.padding(16.dp)) {
                    ...
                    Spacer(modifier = Modifier.height(8.dp))
                    Text("Saldo Pendiente", color = Color.Gray, style = MaterialTheme.typography.labelMedium)
                    Text("$${reserva.monto}", fontWeight = FontWeight.Bold, color = Secundario, style = MaterialTheme.typography.titleMedium)
                }
            }
            ...
            Button(
                onClick = {
                    viewModel.completeDelivery(reservaId)
                    Toast.makeText(context, "Entrega marcada como Completada", Toast.LENGTH_SHORT).show()
                    onBackPressed()
                },
                modifier = Modifier.fillMaxWidth().height(52.dp),
